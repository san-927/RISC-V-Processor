...
// Instruction Decode Stage
    ...
    register_file reg_file_inst(
        ...
        .reg_write_en(RegWrite),    //CONTROL SIGNAL TO ADD
...
wire [63:0] alu_b_in;
assign alu_b_in = /* ALUSRC CHANGE CONTROL SIGNAL AFTER ADDING CU and APPR REG.*/? ID_EX_imm_out: ID_EX_reg_data2;
...
alu_64_bit alu_inst(
    .a(ID_EX_reg_data1),
    .b(alu_b_in),
    .opcode(/* Add add opcode*/), //Control Signal
    .result(alu_result),
...
assign reg_write_data = /* ALUSRC CHANGE CONTROL SIGNAL AFTER ADDING CU and APPR REG.*/? MEM_WB_read_data: MEM_WB_alu_result;
